...
public class LangLoader {
    ...
    public LangLoader(String datFolder, String lang) {
        ...
        InputStream is = AngelGates.class.getResourceAsStream("/lang/" + lang + ".txt");
        if (is != null) {
            defList = load("en", is);
        } else {
            defList = null;
            AngelGates.log.severe("Error loading backup language. There may be missing text ingame");
        }
    }
    ...
    private void updateLanguage(String lang) {
        ...
        try {
            ...
            // Save file
            fos = new FileOutputStream(new File(datFolder, lang + ".txt"));
        ...
        if (updated) {
            AngelGates.log.info("Your language file (" + lang + ".txt) has been updated");
        }
    }
    ...
    private HashMap<String, String> load(String lang, InputStream is) {
        ...
        try {
            if (is == null) {
                File f = new File(datFolder, lang + ".txt");
    ...
    public void debug() {
        ...
        for (String key : keys) {
            AngelGates.debug("LangLoader::Debug::strList", key + " => " + strList.get(key));
        }
        ...
        for (String key : keys) {
            AngelGates.debug("LangLoader::Debug::defList", key + " => " + defList.get(key));
        }
    }
