 ...
 */
public class AngelGatesPortalEvent extends AngelGatesEvent {
    ...
    public AngelGatesPortalEvent(Player player, Portal portal, Portal dest, Location exit) {
        super("AngelGatesPortalEvent", portal);
